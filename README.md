...
**Ping.** is a modern, ultra-fast, and minimalist Asian Drama streaming platform designed with **Apple-inspired aesthetics**. Built specifically for vertical drama lovers, it features a cinematic vertical player, infinite scrolling, and a seamless "app-like" experience on the web.

> **Note:** This project is a frontend client designed to consume unofficial DramaBox APIs.
...
- **📱 Vertical Cinema Mode:** Optimized player for vertical dramas (9:16 aspect ratio) with sticky positioning on desktop and immersive full-screen feel on mobile.
...
- **⏭️ Auto-Play UX:** Auto-next episode, scroll-to-active episode list, and quick navigation controls.
...
```bash
git clone https://github.com/david-aistudio/PingDrama.git
cd PingDrama
```
