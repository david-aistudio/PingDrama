...
export default function TrendingPage() {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => api.getTrending(pageParam),
    initialPageParam: 1,
  ...
  return (
    <div className="container mx-auto px-6 md:px-12 py-12 space-y-12">
      <div className="border-b border-white/5 pb-10">
           <h1 className="text-4xl font-semibold text-white tracking-tight">Trending</h1>
           <p className="text-white/40 text-sm mt-2 font-medium">Most popular dramas this week.</p>
      </div>
