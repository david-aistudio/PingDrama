...
export default function DubIndoPage() {
  ...
  const {
    ...
    queryKey: ['dubIndo-infinite'],
    queryFn: ({ pageParam = 1 }) => api.getDubIndo('terbaru', pageParam),
    initialPageParam: 1,
  ...
  return (
    <div className="container mx-auto px-6 md:px-12 py-12 space-y-12">
      <div className="border-b border-white/5 pb-10">
           <h1 className="text-4xl font-semibold text-white tracking-tight">Dubbed</h1>
           <p className="text-white/40 text-sm mt-2 font-medium">Dramas with Bahasa Indonesia audio.</p>
      </div>
